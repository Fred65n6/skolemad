...
class Server {
  ...
  async respond(request, options = {}) {
    ...
    if (!this.options.hooks) {
      const module2 = await Promise.resolve().then(() => __toESM(require("./chunks/hooks-5b953b47.js")));
      this.options.hooks = {
